...
public class Registration {
    ...
    // welcome to portal - choose login or register
    ...
    // if - admin then choose login or register
    ...
    // if login then display login - passing loggedInUser to respective dashboards
...
//            ((Student) loggedInUser).unregisteredFromCourse(selectedCourse, loggedInUser);
    ...
    // label saying username has logged out
